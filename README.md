...
### Моё решение
Я поставил себе задачу, найти информацию для заголовков книг с сайта https://igraslov.store/ на стороннем ресурсе.
С другой стороны всю необходимую информацию можно было найти на вышеуказанном сайте.
